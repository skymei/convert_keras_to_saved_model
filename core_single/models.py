...
import logging
from core_single.utils import Utils
from core_single.layers import DeprocessStylizedImage
from core_single.reflection_padding import ReflectionPadding2D
...
class StyleTransferNetwork(object):
    ...
    def _convolution(
        ...
        # Set _keras_shape equals to output_shape to avoid merge/add problem
        # output_shape = tuple(out.get_shape().as_list())
        # if hasattr(out, '_keras_shape'):
        #     out._keras_shape = output_shape
